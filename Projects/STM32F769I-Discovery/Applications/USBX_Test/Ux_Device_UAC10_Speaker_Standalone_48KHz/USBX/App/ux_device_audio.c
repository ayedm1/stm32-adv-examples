...
extern AUDIO_DescriptionTypeDef PlaybackAudioDescription;
/* USER CODE END PV */
  ...
  if (status == UX_SUCCESS)
  {
    switch(audio_control[0].ux_device_class_audio10_control_changed)
    {
      case UX_DEVICE_CLASS_AUDIO10_CONTROL_MUTE_CHANGED:
        ...
        /* Update mute state */
        PlaybackAudioDescription.audio_mute = audio_control[0].ux_device_class_audio10_control_mute[0];
      ...
      case UX_DEVICE_CLASS_AUDIO10_CONTROL_VOLUME_CHANGED:
        ...
        PlaybackAudioDescription.audio_volume_db_256 = (audio_control[0].ux_device_class_audio10_control_volume[0]);
