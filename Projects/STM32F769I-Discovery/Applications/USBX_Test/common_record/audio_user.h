...
#define AUDIO_SAMPLE_COUNT_LENGTH(freq)                         ((uint32_t)(((uint32_t)(freq))/1000))
#define AUDIO_MAX_SAMPLE_COUNT_LENGTH(freq)                     (((freq) + 999)/1000)
#define AUDIO_PACKET_SAMPLES_COUNT(freq)                        ((freq)/1000)
